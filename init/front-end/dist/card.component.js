...
var _cardComponent = _interopRequireDefault(require("./card.component.html"));
...
var CardComponent = exports.CardComponent = /*#__PURE__*/function (_Component) {
  function CardComponent(id) {
    ...
    _this = _callSuper(this, CardComponent, [_cardComponent.default]);
    _this._flipped = false;
    _this.template = _cardComponent.default;
  ...
  return _createClass(CardComponent, [{
    ...
    key: "flip",
    value: /* method CardComponent.getElement */
...
}(_component.Component); // TODO #card-component: Change images location to /ap../../scripts/components/game/card/assets/***.png
